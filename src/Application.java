...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        out.println("Calculating sum of cubes' IDs...");
        for (Game game : games) {
            sumIds = sumIds + game.evaluateGame(totalRedCubes, totalGreenCubes, totalBlueCubes);
        }

        out.println("***************************************************");
        out.println("            The sum of IDs is " + sumIds);
        out.println("***************************************************");
    }
    ...
    static Game processGameLine(String pLine) {
        ...
        String[] subsetsStr = parts[1].split(";"); // Split subsets by ";"
